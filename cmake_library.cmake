...
#-----------------------------------------------------------------------------------------------------------------------
# Build/Binary Directory Configuration
#-----------------------------------------------------------------------------------------------------------------------
#execute_process(
        #COMMAND ${CMAKE_COMMAND} -S ${LIBRARY_SOURCE_DIR} -B ${LIBRARY_BINARY_DIR}
        #WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
        #RESULT_VARIABLE EXIT_STATUS
#)

# Fail the configuration process if creating the build/binary directory fails
